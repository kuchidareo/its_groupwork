...
tree = ET.parse("osm.passenger.trips.reduced.xml")

root = tree.getroot()

soulEV65 = "soulEV65"
constant_power_intake = 100000 # default: 100
...
evConfig = f'''<vType id="soulEV65" minGap="2.50" maxSpeed="29.06" color="white" accel="1.0" decel="1.0" sigma="0.0" emissionClass="Energy/unknown">
    <param key="has.battery.device" value="true"/>
    <param key="airDragCoefficient" value="0.35"/>       <!-- https://www.evspecifications.com/en/model/e94fa0 -->
    <param key="constantPowerIntake" value="{constant_power_intake}"/>       <!-- observed summer levels -->
...
tree.write('car.ev.trips.50.xml')
